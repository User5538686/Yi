...
<a href="https://huggingface.co/01-ai">
  <img src="specify theme context for images
...
Serving
ScaleLLM: Efficiently run Yi models locally.
Quantization
TheBloke/Yi-34B-GGUF
TheBloke/Yi-34B-GPTQ
Finetuning
NousResearch/Nous-Capybara-34B
SUSTech/SUS-Chat-34B: This model ranks first among all models below 70B and has outperformed the twice larger deepseek-llm-67b-chat. You can check the result in 🤗 Open LLM Leaderboard.
Model Performance
